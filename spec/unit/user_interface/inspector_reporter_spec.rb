...
module Pod
  describe UserInterface::InspectorReporter do
    ...
    it "handles inspector_successfully_received_report" do
      ...
      UI.output.should =~ /Travis CI with Ruby 1.9.x fails for recent pull requests/
      UI.output.should =~ %r{https://github.com/CocoaPods/CocoaPods/issues/646 \[closed\] \[8 comments\]}
